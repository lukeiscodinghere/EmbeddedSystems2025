...
*** Arduino Uno Tamagochi/Wesen ***

Interaktiv, visuell und lernend
...
In dem kann es kurzzeitig nicht interagieren kann (!außer Sleep-Mode Button). Dabei werden die Augen rot und schneller. 
